    ...
    >
      <div className="flex flex-col gap-8 md:flex-row lg:gap-6">
        ...
        <div className="flex flex-1 flex-col">
          ...
          <h4 className="mt-5 text-lg font-medium lg:mt-7 lg:text-xl">
          ...
          <div className="mt-5 flex flex-col gap-5">
            <div className="relative rounded-r-2xl bg-primary lg:rounded-r-[20px]">
              <div className="absolute rounded-br-[10px] bg-background p-[2px] py-0 pr-2">
                <p className="text-2xl/0 from-secondary-100 to-primary-100 bg-gradient-to-br bg-clip-text font-bold text-transparent lg:text-3xl">
                  1
                </p>
              </div>
            ...
            <div className="relative rounded-r-2xl bg-secondary lg:rounded-r-[20px]">
              <div className="absolute rounded-br-[10px] bg-background p-[2px] py-0 pr-2">
